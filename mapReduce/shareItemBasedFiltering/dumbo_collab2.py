import re
from dumbo import identitymapper, sumreducer, nlargestreducer, nlargestcombiner, main
...
def runner(job):
    ...
    opts = [("numreducetasks", "8")] 
    job.additer(mapper4, sumreducer, combiner=sumreducer, opts=opts)
    job.additer(identitymapper, sumreducer, combiner=sumreducer)
